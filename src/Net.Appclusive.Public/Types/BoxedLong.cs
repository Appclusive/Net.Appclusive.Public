...
{
    public class BoxedLong : Boxed<long>
    {
        public static implicit operator BoxedLong(long value)
        {
            return new BoxedLong
            {
                Value = value
            };
        }

        public static implicit operator long(BoxedLong boxed)
        {
            return boxed.Value;
        }
        ...
        public override DateTime ToDateTime(IFormatProvider provider)
        {
            ...
            return epoch.AddSeconds(uint.MaxValue < Value? uint.MaxValue : Value);
        }
