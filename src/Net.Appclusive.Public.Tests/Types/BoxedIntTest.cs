...
using BoxedType = Net.Appclusive.Public.Types.BoxedInt;

namespace Net.Appclusive.Public.Tests.Types
{
    [TestClass]
    public class BoxedIntTest
    {
        ...
        public void ChangeTypeSucceeds()
        {
            ...
            object valueAsObject = Convert.ChangeType(boxed, typeof(int));
