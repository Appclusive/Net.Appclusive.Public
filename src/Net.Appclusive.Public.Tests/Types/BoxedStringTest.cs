...
using BoxedType = Net.Appclusive.Public.Types.BoxedString;

namespace Net.Appclusive.Public.Tests.Types
{
    [TestClass]
    public class BoxedStringTest
    {
        public const string VALUE = "tralala";
        ...
        public void ChangeTypeSucceeds()
        {
            ...
            object valueAsObject = Convert.ChangeType(boxed, typeof(string));
